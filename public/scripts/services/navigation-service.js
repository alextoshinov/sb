...
angular.module("showyBulgariaApp").
	factory("navigation", ["$location", function($location) {
		...
		NavigationService.prototype.onLogout = function() {
			return $location.path() === "/logout";
		};

		NavigationService.prototype.onLogin = function() {
			return $location.path() === "/login";
		};

		NavigationService.prototype.onSignup = function() {
			return $location.path() === "/signup";
		};

		NavigationService.prototype.onProfile = function() {
